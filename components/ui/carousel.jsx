    ...
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ? "top-1/2 -left-16 -translate-y-1/2 ssm:w-13 ssm:h-13 w-16 h-16 flex items-center justify-center"
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute rounded-full",
        orientation === "horizontal"
          ? "top-1/2 -right-16 -translate-y-1/2  ssm:w-13 ssm:h-13 w-16 h-16 flex items-center justify-center"
