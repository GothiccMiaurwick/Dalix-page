    ...
    <section className="w-full bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 xl:gap-16 px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-12">
        ...
        <div className="flex flex-col gap-3 sm:gap-4">
          {/* Imagen principal */}
          <div className="w-full aspect-square relative overflow-hidden rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <Image
              src={mainImage}
              alt={product.title}
              fill
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {product.sizes.map((size) => (
                <button
                  ...
                  className={`px-5 py-2.5 sm:px-6 sm:py-3 md:px-7 md:py-3.5 border-2 rounded-lg transition-all duration-200 font-medium text-sm sm:text-base md:text-lg ${
                    activeSize === size
