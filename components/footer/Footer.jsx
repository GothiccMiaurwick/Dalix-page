...
export default function Footer() {
  const socialLinks = [
    ...
    },
    {
      ...
      icon: "https://img.icons8.com/ios-filled/50/pinterest.png",
    },
  ];
          ...
          <div className="flex justify-center gap-3 sm:gap-4 md:gap-5 mb-6 sm:mb-7 md:mb-8">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gray-300 rounded-full flex items-center justify-center hover:bg-white transition-all duration-300 hover:scale-110"
